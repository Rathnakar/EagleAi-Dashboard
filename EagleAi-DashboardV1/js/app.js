var app=angular.module('app', ['ngRoute', 'ngCookies','ui.bootstrap.accordion','ui.bootstrap','ngMaterial', 'material.svgAssetsCache','multipleDatePicker']);
    ...
    app.config(function($routeProvider, $locationProvider) {
		...
		$rootScope.toggleMin = function() {
			$rootScope.options.minDate = $rootScope.options.minDate ? null : new Date();
		};
